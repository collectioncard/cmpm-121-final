...
public class BetterTerrain
{
    ...
    public enum SymmetryType
    {
        ...
        All =
            8 // All rotated and reflected forms
        ,
    }
    ...
    {
        return (Array<Godot.Collections.Dictionary<string, Variant>>)
            betterTerrain.Call(MethodName.GetTerrainCategories, tileMapLayer.TileSet);
    }
    ...
    public bool AddTerrain(
        ...
        Color color,
        TerrainType type,
        Array<int> categories = null,
        Godot.Collections.Dictionary<Variant, Variant> icon = null
    )
    {
    ...
    public Godot.Collections.Dictionary<string, Variant> GetTerrain(int index)
    {
        return (Godot.Collections.Dictionary<string, Variant>)
            betterTerrain.Call(MethodName.GetTerrain, tileMapLayer.TileSet, index);
    }
    ...
    {
        return (bool)
            betterTerrain.Call(MethodName.SwapTerrains, tileMapLayer.TileSet, index1, index2);
    }

    public bool SetTileTerrainType(TileData tileData, int type)
    {
        return (bool)
            betterTerrain.Call(MethodName.SetTileTerrainType, tileMapLayer.TileSet, tileData, type);
    }
    ...
    public bool SetTileSymmetryType(TileData tileData, SymmetryType type)
    {
        return (bool)
            betterTerrain.Call(
                MethodName.SetTileSymmetryType,
                tileMapLayer.TileSet,
                tileData,
                (int)type
            );
    ...
    {
        return (Array<TileData>)
            betterTerrain.Call(MethodName.GetTilesInTerrain, tileMapLayer.TileSet, type);
    }

    public Array<Godot.Collections.Dictionary<string, Variant>> GetTileSourcesInTerrain(int type)
    {
        return (Array<Godot.Collections.Dictionary<string, Variant>>)
            betterTerrain.Call(MethodName.GetTileSourcesInTerrain, tileMapLayer.TileSet, type);
    }
    ...
    public bool RemoveTilePeeringType(TileData tileData, TileSet.CellNeighbor peering, int type)
    {
        return (bool)
            betterTerrain.Call(
                MethodName.RemoveTilePeeringType,
                tileMapLayer.TileSet,
                tileData,
                (int)peering,
                type
    ...
    {
        return (Array<TileSet.CellNeighbor>)
            betterTerrain.Call(MethodName.TilePeeringKeys, tileData);
    }
    ...
    {
        return (Array<TileSet.CellNeighbor>)
            betterTerrain.Call(MethodName.TilePeeringForType, tileData, type);
    }
    ...
    public Godot.Collections.Dictionary<Variant, Variant> CreateTerrainChangeset(
        Godot.Collections.Dictionary<Vector2I, int> paint
    )
    {
        return (Godot.Collections.Dictionary<Variant, Variant>)
            betterTerrain.Call(MethodName.CreateTerrainChangeset, tileMapLayer, paint);
    }
